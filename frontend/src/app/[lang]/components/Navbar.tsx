...
function NavLink({ url, text }: NavLink) {
  ...
  return (
    <li className="flex">
      <Link
        href={url}
        className={`font-arupala font-light text-sm flex items-center mx-4 -mb-1 border-b-2 dark:border-transparent ${
    ...
    <div className="dark:bg-midnight-blue dark:text-gray-100 border-b border-purple">
      <div className="px-4 py-2 md:px-[20px] lg:px-[120px]  max-w-[1440px] mx-auto">
        <div className="flex justify-between h-16 mx-auto px-0">
          <Logo src={logoUrl}>
            {logoText && (
              <h2 className="text-base md:text-lg font-bold">{logoText}</h2>
            )}
          </Logo>
